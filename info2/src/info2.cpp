...
int main(int argc,char **argv) 
{
    ...
    topic.push_back(std::string("/BB2_9211442/right/camera_info"));
   ...
   //ros::Rate r(10);
	...
	if(m.getTopic()=="/BB2_9211442/right/camera_info"){
	...
	buf=to_string(a);
        ...
        bag2.write("/BB2_9211442/right/camera_info", header.stamp, info_msg);
